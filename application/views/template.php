...
<html lang="en">
  ...
  <section id="container" style="background-image: linear-gradient(to right, rgba(40, 60, 134, 0.80), rgba(69, 162, 71, 0.80));">
      <!-- **********************************************************************************************************************************************************
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <div class="fa fa-bars tooltips" data-placement="right" data-original-title="Toggle Navigation"></div>
            ...
            <!--logo start-->
            <a href="<?= base_url()?>index.html" class="logo"><b style="space: 5px;">FIREY SHOP</b></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="<?= base_url()?>profile.html"><img src="<?=base_url()?>assets/15.jpg" class="img-circle" width="70" height="80"></a></p>
              	  <h5 class="centered">Firda Reinika</h5>
              	  	
                    <li class="active">
                    <a href="<?=base_url('index.php/user')?>">
                        <p class="material-icons" ><img src="<?=base_url()?>assets/house1.png" class="img-circle" style="width: 30px;"><div style="margin-right: 85px; margin-top: -33px; font-size: 15px; float: right;">Home</div></p>
                  ...
                  <li class="active">
                      ...
                      <p class="material-icons" ><img src="<?=base_url()?>assets/user1.png" class="img-circle" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right;">Profil</div></p>
                      </a>
                  </li>
                  ...
                  <li class="active">
                      ...
                      <p class="material-icons" ><img src="<?=base_url()?>assets/gallery.png" class="img-circle" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right;">Gallery</div></p>
                      </a>
                  </li>
